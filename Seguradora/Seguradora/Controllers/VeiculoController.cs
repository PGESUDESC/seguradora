...
namespace Seguradora.Controllers
{
    public class VeiculoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Valor,Marca,Modelo,AnoModelo,Combustivel,CodigoFipe,MesReferencia,TipoVeiculo,SiglaCombustivel")] Veiculo veiculo)
        {
            ...
            ViewBag.Marcas = pc.PopulaMarcasDropDownList(veiculo.AnoModelo);
            ViewBag.Modelos = pc.PopulaModelosDropDownList(veiculo.Marca);
            ViewBag.AnoModelos = pc.PopulaAnoModelosDropDownList(veiculo.Modelo);
            return View(veiculo);
        }
